...
def post_evidencias(incidencia_id):
    ...
    for archivo in archivos:
        ...
        try:
            ...
            rechazadas.append(archivo.filename)

    return jsonify({"subidas": subidas, "rechazadas": rechazadas,
                    "mensaje": f"{len(subidas)} evidencia(s) subida(s)."}), 201
...
def get_dashboard():
    ...
    claves = ["desde", "hasta", "anio", "trimestre", "mes", "semana",
              "estado", "categoria", "cliente", "responsable", "tipo", "gravedad"]
