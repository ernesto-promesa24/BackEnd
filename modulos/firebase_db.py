...
Colecciones en Firestore:
    ...
    servicios          { fecha, cliente_id, cliente, categoria, estado,
                         tipo_servicio, hora_programada, hora_real, realizado,
                         resultado, responsable, observaciones, creado_en }
    incidencias        { servicio_id, tipo_incidencia_id, tipo_incidencia,
                         gravedad, reporto_cliente, resuelta, resuelta_a_tiempo,
                         fecha_resolucion, comentarios, evidencias[], creado_en }
